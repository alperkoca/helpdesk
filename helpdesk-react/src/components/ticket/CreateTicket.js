...
const initialState = { mainCategoryId: "", category: "", summary: "", dueDate: Date.now() };
                            ...
                            <select id="category" className="form-control" name="category" onChange={handleChange}>
                                {
                                    ...
                                    categories.find(x => x._id === formData.mainCategoryId)?.categories?.map((c) => <option value={c._id}>{c.name}</option>)
                                }
                            </select>
                        </div>
                        <div className="form-group">
